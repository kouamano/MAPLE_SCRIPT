...
my $thread3 = threads->new(\&client_maple, "150.26.237.19",10000,"for i from 1 to 20000000 do s:=s+i end do",1,1,1,$R[0]);
#my $thread4 = threads->new(\&client_maple, "150.26.237.19",10001,"for i from 1000001 to 2000000 do s:=s+i end do",1,1,1,$R[1]);
$thread3->join; 
#$thread4->join; 
print("R[0]:$R[0]");
print("R[1]:$R[1]");
